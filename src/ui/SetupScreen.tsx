  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <section className="flex flex-col gap-3 rounded-[7px] bg-white p-4 shadow-[0_1px_3px_rgba(26,26,30,0.06)]">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex flex-col gap-2">
            <label className="cursor-pointer rounded-[7px] bg-neutral-100 px-4 py-3 text-base font-bold text-[#1a1a1e]">
            ...
            {photo && (
              <button
                ...
                className="rounded-[7px] px-2 py-1 text-left text-sm font-bold text-red-600"
              >
                Remove photo
              </button>
            )}
        ...
        <input
          ...
          placeholder="Name"
          className="w-full rounded-[7px] bg-[#f5f4ee] px-4 py-3 text-lg text-[#1a1a1e] outline-none ring-orange-500 placeholder:text-neutral-400 focus:ring-2"
        />
        <div className="flex gap-3">
          <input
            ...
            className="w-32 rounded-[7px] bg-[#f5f4ee] px-4 py-3 text-lg text-[#1a1a1e] outline-none ring-orange-500 placeholder:text-neutral-400 focus:ring-2"
          />
          <input
            value={note}
            onChange={(e) => setNote(e.target.value)}
            placeholder='Note e.g. "blonde hair, glasses"'
            className="min-w-0 flex-1 rounded-[7px] bg-[#f5f4ee] px-4 py-3 text-lg text-[#1a1a1e] outline-none ring-orange-500 placeholder:text-neutral-400 focus:ring-2"
          />
        </div>
        <div className="flex gap-3">
      ...
      <section className="flex flex-col gap-2">
        ...
        {roster.length === 0 && (
          <p className="rounded-[7px] bg-white p-4 text-neutral-500 ring-1 ring-hairline">
            Add your squad above — name is enough, the rest is optional.
          </p>
        )}
        {roster.map((p) => (
          <div key={p.id} className="flex items-center gap-3 rounded-[7px] bg-white p-3 shadow-[0_1px_3px_rgba(26,26,30,0.06)]">
            ...
            <button
              type="button"
              onClick={() => startEdit(p)}
              className="rounded-[7px] bg-neutral-100 px-4 py-3 font-bold text-[#1a1a1e]"
            >
              Edit
            </button>
            <button
              ...
              className="rounded-[7px] bg-neutral-100 px-4 py-3 font-bold text-red-600"
            >
              ✕
            </button>
          </div>
      ...
      {import.meta.env.DEV && onLoadDemo && onEraseAll && (
        <section className="flex flex-wrap items-center gap-3 rounded-[7px] border border-dashed border-neutral-300 p-3">
          ...
          <button
            ...
            className="rounded-[7px] bg-white px-4 py-2 text-sm font-bold text-neutral-600 ring-1 ring-hairline"
          >
            Load demo data
          </button>
          <button
            ...
            className="rounded-[7px] bg-white px-4 py-2 text-sm font-bold text-red-600 ring-1 ring-red-200"
          >
            Erase all
          </button>
        </section>
